...
def main(guess,answer=''):
        ...
        while turn <= 6:
                ...
                if guess == answer:
                        ...
                        # NEXT GUESS IS CHOSEN VIA maxFreqList() FROM freq_sort.py
                        guess = fs.maxFreqList(possible)[random.randint(0,len(fs.maxFreqList(possible))-1)]
                        turn += 1
